...
public class OrcaCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject orcaCamera;
	...
	void Update(){
		...
		orcaCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
