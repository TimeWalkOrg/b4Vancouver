...
public class AyuCameraScript : MonoBehaviour {
    public GameObject target;
    public GameObject ayuCamera;
    ...
    void Update()
    {
        ...
        ayuCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
