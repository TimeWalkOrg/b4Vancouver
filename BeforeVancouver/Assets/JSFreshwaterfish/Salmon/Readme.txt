Thank you for downloading Salmon.

This is a semi realistic 3d model and animations of Salmon. 
-Models folder contains FBX file.
...
Demo folder contains an example use of the Salmon model. 
