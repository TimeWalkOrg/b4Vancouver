...
public class RiverFishCameraScript : MonoBehaviour {
    public GameObject target;
    public GameObject riverFishCamera;
    ...
    void Update()
    {
        ...
        riverFishCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
