...
public class FreshwaterfishCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject freshwaterfishCamera;
	...
	void Update(){
		...
		freshwaterfishCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
